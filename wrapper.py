...
class YOLOv7_DeepSORT:
    ...
    def track_video(self,video:str, output:str, skip_frames:int=0, show_live:bool=False, count_objects:bool=False,show_fps:bool=False, verbose:int = 0):
        '''
        ...
        while True: # while video is running
            ...
            if count_objects:
                ...
                cv2.putText(frame, "Objects being tracked: {}".format(count), (5, 35), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1.5, (0, 255, 0), 2)
            ...
            if show_fps:
                #300
                cv2.putText(frame, "FPS: {}".format({round(fps,2)}), (5, 65), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1.5, (255, 0, 0), 2)
